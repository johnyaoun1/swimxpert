...
builder.Services.AddSingleton<IAdminPasswordRevealVault, AdminPasswordRevealVault>();
...
using (var scope = app.Services.CreateScope())
{
    ...
    await db.Database.ExecuteSqlRawAsync("ALTER TABLE \"Users\" ADD COLUMN IF NOT EXISTS \"AdminPasswordRevealCipher\" character varying(512);");
    await db.Database.ExecuteSqlRawAsync("""
