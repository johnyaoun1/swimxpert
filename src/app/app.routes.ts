...
export const routes: Routes = [
  ...
  { path: 'quizzes', loadComponent: () => import('./pages/quizzes/quizzes.component').then((m) => m.QuizzesComponent), title: 'Swimming Quiz - SwimXpert' },
  { path: 'leaderboard', loadComponent: () => import('./pages/leaderboard/leaderboard.component').then((m) => m.LeaderboardComponent), title: 'Leaderboard - SwimXpert' },
